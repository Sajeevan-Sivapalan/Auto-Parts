...
import com.example.automate.adapter.ProductAdapter;
import com.example.automate.model.CartManagerSingleton;
import com.example.automate.model.Product;

public class HomeActivity extends AppCompatActivity {

    private DrawerLayout navigatorDrawer, drawerLayout;
    private ImageButton buttonDrawerToggle, buttonDrawerMenuRight, arrowButton;
    private NavigationView navigationView;
    private TextView textUsername, textUserEmail, cart_count, textViewNoProducts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set OnClickListener for drawer to show menu
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                navigatorDrawer.close();
                return true;
            }
        });

        // Set OnClickListener for filter drawer
    ...
    // Get selected categories from filters
    ...
    private void loadProducts() {
        ...
        productList.add(new Product("2", "Oil Filter", "https://res.cloudinary.com/knfilters-com/image/upload/c_lpad,dpr_2.0,f_auto,h_540,q_auto,w_540/v1/media/catalog/product/H/P/HP-1007-REV_2.jpg?_i=AB", "category2", "Oil filter for various car models.", 19.99, 150, true, "vendor2", "2024-01-01", "2024-01-10", "Filters", "PartsCo", 5));
        productList.add(new Product("3", "Spark Plugs", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRHAvLF5RY893z8KAjXXdrlTn4JqSDAyqaW3w&s", "category3", "Durable spark plugs for better ignition.", 9.99, 200, true, "vendor3", "2024-01-01", "2024-01-10", "Ignition", "SparkPro", 3));
        productList.add(new Product("4", "Car Battery", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS0BPa8MIIBTHCzvLkS69bnX-tR0CO9oacrfA&s", "category4", "Long-lasting car battery with high performance.", 129.99, 80, true, "vendor4", "2024-01-01", "2024-01-10", "Batteries", "PowerMax", 4));
        productList.add(new Product("5", "Tire Pressure Gauge", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR6tR9TUsq7M0PkHxCdc8pVvrI9VhzJHrl4lA&s", "category5", "Essential tire pressure gauge for maintaining proper pressure.", 15.99, 120, true, "vendor5", "2024-01-01", "2024-01-10", "Tools", "GaugeMate", 2));
    ...
    // Clear unique categories from the product list
    private List<String> getDistinctCategories(List<Product> products) {
        Set<String> categories = new HashSet<>();
        for (Product product : products) {
            categories.add(product.getProductCategoryName());
        }
        return new ArrayList<>(categories);
    }

    // Clear category checkbox for unique categories
